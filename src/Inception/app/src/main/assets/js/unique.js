...
file.writeLine("one");                       <i>only now is file actually opened</i>
file.writeLine("two");
file.writeLine("thr", "ee");
file.close();                                <i>must close file before we can reopen for reading</i>

var a = file.readLines();                    <i>creates and fills an array with the contents of the file</i>
